...
class HBSNetworkManager {
    ...
    class func hbs_request(_ url: String, method: HTTPMethod = .get, parameters: Parameters? = nil, encoding: ParameterEncoding = URLEncoding.default, headers: HTTPHeaders? = Server().Header, success: @escaping(_ data: Any) -> (), failure: @escaping(_ error: HBSNetworkError) -> ()) {
