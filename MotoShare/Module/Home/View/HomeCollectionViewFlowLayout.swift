...
@objc protocol HomeCollectionViewFlowLayoutDelegate : NSObjectProtocol {
    /// 返回高度
    func hw_setCellHeght(layout : HomeCollectionViewFlowLayout,indexPath : NSIndexPath,itemWidth : CGFloat) -> CGFloat
    
    /// 返回行数
    @objc optional func hw_columnCountInWaterFlowLayout(layout : HomeCollectionViewFlowLayout) -> Int
    /// 返回列间距
    @objc optional func hw_columnMarginInWaterFlowLayout(layout : HomeCollectionViewFlowLayout) -> CGFloat
    /// 返回行间距
    @objc optional func hw_rowMarginInWaterFlowLayout(layout : HomeCollectionViewFlowLayout) -> CGFloat
    
    @objc optional func hw_edgeInsetsInWaterFlowLayout(layout : HomeCollectionViewFlowLayout) -> UIEdgeInsets
}

class HomeCollectionViewFlowLayout: UICollectionViewFlowLayout {
    
    weak open var delegate : HomeCollectionViewFlowLayoutDelegate?
    ...
    fileprivate let defaultEdgeInsets : UIEdgeInsets = UIEdgeInsets(top: 10, left: 20, bottom: 10, right: 20)
    /*懒加载创建存放属性的数组*/
